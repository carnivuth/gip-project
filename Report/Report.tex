...
\begin{document}
	...
	\textbf{Il problema}\\
	Tra tutte le fonti di energia rinnovabile, l'energia solare è quella più presente nella vita di tutti i giorni tramite impianti comporti da pannelli solari e fotovoltaici. Questi impianti, essendo installati all'aria aperta, sono esposti alle condizioni climatiche che sporcano la superficie fotovoltaica attraverso polvere, smog, foglie e sabbia.\\
	Senza una pulizia adeguata, un pannello sporco può perdere fino al 30\% della propria efficienza energetica, riducendone il potenziale. Tuttavia se non ci si vuole rivolgere a specialisti della pulizia ogniqualvolta è necessario un intervento, le uniche soluzioni autopulenti sono estremamente costose oppure non prive di difetti.\\\\
	\textbf{La soluzione}\\
	...
	La soluzione proposta può risultare accattivante sia per nuovi utenti che per utilizzatori di vecchia data del fotovoltaico, perché il prodotto si va ad aggiungere a impianti già esistenti cooperandovi per migliorare le prestazioni.\\\\
	%\textbf{Il settore}\\
	%Come tutte le fonti di energia rinnovabile, anche il settore del fotovoltaico è in rapido aumento. Ciò è dovuto sia al fatto che queste risorse stanno guadagnando sempre più importanza, sia al fatto che il costo degli impianti fotovoltaici sta diminuendo nel tempo.\\
	%Il settore è ricco di prodotti che integrano le capacità degli impianti fotovoltaici andando ad implementare features aggiuntive in modo simile ad \emph{Osmos}. In una situazione di questo tipo il progetto proposto per affermarsi fa leva sulla mancanza di soluzioni analoghe, oltre che sulla possibilità di fornire un beneficio al cliente.\\\\
	%\textbf{Il mercato}\\\\
