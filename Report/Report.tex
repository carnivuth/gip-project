...
\begin{document}
	...
	\textbf{Il problema}\\
	Tra tutte le fonti di energia rinnovabile, l'energia solare emerge come la più pervasiva nella nostra vita quotidiana, attraverso l'impiego di impianti principalmente costituiti da pannelli solari e fotovoltaici. Questi sistemi essendo installati all'aperto, si trovano inevitabilmente esposti alle condizioni climatiche, che ne compromettono l'efficienza a causa di: accumuli di polvere, inquinamento atmosferico, foglie e sabbia.\\
	In assenza di un adeguato processo di pulizia un modulo solare contaminato potrebbe subire una perdita di efficienza energetica persino del 30\%, comportando una significativa diminuzione del suo potenziale. Tuttavia, nel caso in cui non si desideri ricorrere all'assistenza di professionisti per la pulizia, le soluzioni di autolavaggio risultano notevolmente dispendiose o affette da imperfezioni.\\\\
	\textbf{La soluzione}\\
	...
	La superficie può venire sporcata da diversi fattori: tra i più comuni vi sono piogge acide, polveri e smog, ma anche foglie, guano e sabbia. Nella figura di seguito si mostra un esempio di impianto particolarmente sporco: %era già stato elencato prima
	\begin{figure}[h]
		\centering\includegraphics[width=0.5\textwidth]{Images/pannelli_sporchi2.jpg}
	\end{figure}\\
	Per affrontare il problema della pulizia il proprietario dell'impianto può scegliere se rivolgersi ad imprese specializzate che effettuano pulizia a domicilio, oppure prevenire il problema scegliendo di installare pannelli autopulenti di ultima generazione. Entrambe queste soluzioni hanno però dei limiti: riguardo la prima soluzione è l'utente stesso che deve accorgersi di quando sopraggiunge il momento opportuno per eseguire la pulizia e mobilitarsi per contattare l'impresa adeguata, per un costo che in media varia tra i 100\euro e i 300\euro.\\
	...
	Per studiare i bisogni e i desideri dei potenziali clienti si è deciso di diffondere una \emph{survey} contenente domande di vario genere legate ai pannelli fotovoltaici, diversificate in base a possessori o non possessori di questi impianti. Nei confronti dei possessori dell'impianto fotovoltaico è stata posta particolare attenzione al tema della pulizia.\\
	...
	\textbf{Value Proposition}\\%ci ripetiamo spesso
